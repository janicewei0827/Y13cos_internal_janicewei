...
class Track:
    def __init__(self, parent):
        ...
        #minutes spent on virus protection (row 4)
        self.mins_spent_label = Label(self.input_boxes_frame, text="Minutes Spent On Virus Protection ",
                                      font="Arial 16", bg=background_color1, fg=text_color,
                                      wrap=160, justify=LEFT)
        self.mins_spent_label.grid(row=4, column=0, sticky='w', padx=20, pady=5)
        self.mins_spent_entry = Entry(self.input_boxes_frame, width=15,
                                      font="Arial 13 bold")
        self.mins_spent_entry.grid(row=4, column=1, sticky='e', padx=20, pady=5)

        #whether 'wof and tune' is required (row 5)
        self.wof_tune_label = Label(self.input_boxes_frame, text="If A 'WOF and tune' Service Is Required?",
                                    font="Arial 16", bg=background_color1, fg=text_color, wrap=160, justify=LEFT)
        self.wof_tune_label.grid(row=5, column=0, sticky='w', padx=20, pady=5, columnspan=1)
        self.wof_tune_entry = Entry(self.input_boxes_frame, width=15,
                                    font="Arial 13 bold")
        self.wof_tune_entry.grid(row=5, column=1, sticky='e', padx=20, pady=5)
