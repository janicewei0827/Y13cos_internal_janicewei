...
class Track:
    def __init__(self, parent):
        ...
        #for testing purpose (test empty lists)
        #self.job_numbers = []
        #self.names = []
        #self.charges = []
...
class View:
    def __init__(self, partner,job_numbers, names, charges):
        ...
        self.job_number_value_label = Label(self.details_frame, text=job_numbers[current_index],
        ...
        self.name_value_label = Label(self.details_frame, text=names[current_index],
                                      font="Arial 18", bg=background_color1, fg=text_color1,
        ...
        self.charge_value_label = Label(self.details_frame, text=charges[current_index],
                                        font="Arial 18", bg=background_color1, fg=text_color1,
                                         justify=LEFT)
